...
void Pessoa::AbreFecha(double a)
{
	Interpolator * ptrInterpolatorLeftArm = new PolinomialInterpolator(PolinomialInterpolator::CubicaEQuadrada);
	Interpolator * ptrInterpolatorLeftForearm = new PolinomialInterpolator(PolinomialInterpolator::CubicaEQuadrada);
	Interpolator * ptrInterpolatorRightArm = new PolinomialInterpolator(PolinomialInterpolator::CubicaEQuadrada);
	...
	ptrInterpolatorLeftArm->addAttribute(new AttrVector3(vec3(0.0f, 0.0f, 0.0f), a+3, PoseAttr::ROTATE)); // tempo: 0 seg
	ptrInterpolatorLeftArm->addAttribute(new AttrVector3(vec3(0.0f, 0.0f, 120.0f), a + 4, PoseAttr::ROTATE)); // tempo: 1 seg
	ptrInterpolatorLeftArm->addAttribute(new AttrVector3(vec3(0.0f, 0.0f, 95), a + 4.25, PoseAttr::ROTATE)); // tempo: 1 seg
	ptrInterpolatorLeftArm->addAttribute(new AttrVector3(vec3(0.0f, 0.0f, 120.0f), a + 4.5, PoseAttr::ROTATE)); // tempo: 1 seg
	ptrInterpolatorLeftArm->addAttribute(new AttrVector3(vec3(0.0f, 0.0f, 120.0f), a + 6, PoseAttr::ROTATE)); // tempo: 1 seg
	ptrInterpolatorLeftArm->addAttribute(new AttrVector3(vec3(0.0f, 0.0f, 0.0f), a + 7, PoseAttr::ROTATE)); // tempo: 1 seg

	ptrInterpolatorLeftForearm->addAttribute(new AttrVector3(vec3(0.0f, 0.0f, 0.0f), a, PoseAttr::ROTATE)); // tempo: 0 seg
	ptrInterpolatorLeftForearm->addAttribute(new AttrVector3(vec3(90.0f, 0.0f, 0.0f), a+1, PoseAttr::ROTATE)); // tempo: 1 seg
	ptrInterpolatorLeftForearm->addAttribute(new AttrVector3(vec3(0.0f, 0.0f, 0.0f), a+2, PoseAttr::ROTATE)); // tempo: 1 seg

	ptrInterpolatorRightArm->addAttribute(new AttrVector3(vec3(0.0f, 0.0f, 0.0f), a + 3, PoseAttr::ROTATE)); // tempo: 0 seg
	ptrInterpolatorRightArm->addAttribute(new AttrVector3(vec3(0.0f, 0.0f, -120.0f), a + 4, PoseAttr::ROTATE)); // tempo: 1 seg
	ptrInterpolatorRightArm->addAttribute(new AttrVector3(vec3(0.0f, 0.0f, -95.0f), a + 4.25, PoseAttr::ROTATE)); // tempo: 1 seg
	ptrInterpolatorRightArm->addAttribute(new AttrVector3(vec3(0.0f, 0.0f, -120.0f), a + 4.5, PoseAttr::ROTATE)); // tempo: 1 seg
	ptrInterpolatorRightArm->addAttribute(new AttrVector3(vec3(0.0f, 0.0f, -120.0f), a + 6, PoseAttr::ROTATE)); // tempo: 1 seg
	ptrInterpolatorRightArm->addAttribute(new AttrVector3(vec3(0.0f, 0.0f, 0.0f), a + 7, PoseAttr::ROTATE)); // tempo: 1 seg

	ptrInterpolatorRightForearm->addAttribute(new AttrVector3(vec3(0.0f, 0.0f, 0.0f), a + 2, PoseAttr::ROTATE)); // tempo: 0 seg
	ptrInterpolatorRightForearm->addAttribute(new AttrVector3(vec3(45.0f, 0.0f, 0.0f), a + 3, PoseAttr::ROTATE)); // tempo: 1 seg
	ptrInterpolatorRightForearm->addAttribute(new AttrVector3(vec3(0.0f, 0.0f, 0.0f), a + 4, PoseAttr::ROTATE)); // tempo: 1 seg
...
void Pessoa::Frente(double, double, double)
{
...
void Pessoa::Initialize() {
	/* Corpo */
	Model* corpo = new Model("objs/box.obj", isMorty ? "textures/yellow.jpg" : "textures/branco.jpg");
	corpo->setScale(glm::vec3(0.3, 0.4, 0.1));
	corpo->setTranslate(glm::vec3(0, 0.6, 0));
	this->listOfEntities.push_back(corpo);

	Model* head = new Model("objs/box.obj", "textures/pele.jpg");
	...
	if (isMorty)
	{
		Model* leftArmJoint = new Model("objs/circle.obj", "textures/marrom_e.jpg");
		leftArmJoint->setScale(glm::vec3(0.065, 0.075, 0.05));
		leftArmJoint->setTranslate(glm::vec3(0.0, 0.95, 0.07));
		leftArmJoint->setRotate(glm::vec3(-35.0, 0.0, 0));
		this->listOfEntities.push_back(leftArmJoint);
	}
	else {
		Model* leftArmJoint = new Model("objs/rickmotafukka.obj", "textures/azul_c.jpg");
		leftArmJoint->setScale(glm::vec3(0.25, 0.25, 0.25));
		leftArmJoint->setRotate(glm::vec3(0, 90.0, 0));
		leftArmJoint->setTranslate(glm::vec3(0.0, 1.025, 0));
		this->listOfEntities.push_back(leftArmJoint);
	}
	/* Braco esquerdo */
