...
void SkyBox::Initialize()
{
	...
	faces.push_back("textures/skybox/plains/right.jpg");
	faces.push_back("textures/skybox/plains/left.jpg");
	faces.push_back("textures/skybox/plains/top.jpg");
	faces.push_back("textures/skybox/plains/bottom.jpg");
	faces.push_back("textures/skybox/plains/back.jpg");
	faces.push_back("textures/skybox/plains/front.jpg");
