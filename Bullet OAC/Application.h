...
private:
	...
	vector<class Light*>	listOfLight;				//!< lista de luzes
...
public:
	...
	*/
	inline unsigned int GetMainShaderId() { return this->uiProgramId; };
	...
	*/
	...
	\return unsigned int do ID do vetor de Ambient Lightning
	*/
	inline unsigned int GetBillboardColorMod() { return this->uiBillboardColorMod; };
